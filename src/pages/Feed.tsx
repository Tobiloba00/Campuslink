...
const Feed = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1400px] mx-auto px-4 pt-20 pb-24 lg:pb-8">
        <div className="flex gap-8 justify-center">
          {/* ─── Left Sidebar ─── */}
          <aside className="hidden lg:block w-56 flex-shrink-0">
            <div className="sticky top-20 space-y-5 pt-4">
          ...
          <main className="w-full max-w-[600px]">
            {/* Search */}
            <div className="sticky top-14 z-30 bg-background/80 backdrop-blur-xl pb-3 pt-4 -mx-1 px-1">
